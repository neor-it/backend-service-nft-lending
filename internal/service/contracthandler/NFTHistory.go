...
func GetNFTHistory(client *ethclient.Client, contractAddress common.Address, tokenAddress common.Address, tokenId *big.Int, walletAddress common.Address, db *sql.DB) []structure.Event {
	...
	for _, signature := range signatures {
		nftEvents, err := database.TrackEvents(client, contractAddress, signature, db)
		if err != nil {
			log.Fatal(err)
		}
